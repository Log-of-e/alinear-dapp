...
export default function App() {
  ...
  const [greeting, set_greeting] = React.useState("Welcome")

  const [nameofbounty, setNameofbounty] = React.useState("")

  const [bountydate, setBountydate] = React.useState("")
  ...
  if (!window.walletConnection.isSignedIn()) {
    return (
      <main>
        ...
        <h1>Welcome to Alinear Super Employees </h1>
        ...
        <p>
          Go ahead and sign and start Locating Super Employees
        </p>
    ...
    <>
      ...
      <main>
        ...
        <form
          ...
          <fieldset id="bountynamefield">
            <label
              htmlFor="nameofbounty"
            ...
            <div
              ...
              <input
                ...
                value={nameofbounty}
                id="nameofbounty"
                onChange={e => setNameofbounty(e.target.value)}
                style={{ flex: 1 }}
              />
            </div>
